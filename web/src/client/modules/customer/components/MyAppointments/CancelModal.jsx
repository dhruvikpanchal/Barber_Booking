...
import { formatDateTime } from "../../data/appointmentsData.js";
        ...
        <div className="space-y-4 p-5">
          ...
          <div className="border-status-pending/20 bg-status-pending/5 rounded-xl border px-4 py-3">
            <p className="text-on-surface text-xs leading-relaxed">
              <span className="font-semibold">Cancellation policy:</span> Free cancellations up to
              24 hours before your appointment. Late cancellations may incur a{" "}
