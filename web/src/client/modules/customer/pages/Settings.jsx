...
import OAuthPasswordNotice from "@/client/modules/shared/components/settings/OAuthPasswordNotice.jsx";
...
export default function Settings() {
  ...
  const { data: profile } = customerHook.Profile.useGetProfile();
    ...
    <div className="text-on-surface mx-auto w-full max-w-6xl min-w-0 space-y-6 md:space-y-8">
      ...
      <div className="flex flex-col gap-6 md:flex-row">
        ...
        <div className="min-w-0 flex-1 space-y-6">
          {active === "password" &&
            (profile?.hasPasswordLogin === false ? (
              <OAuthPasswordNotice />
            ) : (
              <PasswordSection
                onToast={showToast}
