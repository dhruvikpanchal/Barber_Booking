...
export default function LandingSearchStrip() {
  return (
      ...
      <div className="mx-auto max-w-5xl">
        ...
        >
          ...
          <label className="flex items-center gap-3 bg-surface-container px-5 py-4">
            ...
            <input
              className="font-label-caps w-full min-w-0 bg-transparent text-on-surface placeholder:text-on-surface-variant focus:outline-none"
          ...
          <button
            type="submit"
            className="group flex min-h-14 items-center justify-center gap-2 bg-primary px-8 py-4 font-label-caps text-on-primary transition-all duration-300 hover:bg-primary/90 hover:shadow-lg md:min-w-[180px]"
          >
            <Search
