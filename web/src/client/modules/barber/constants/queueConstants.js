import { Clock, Scissors, CheckCircle2, XCircle, PauseCircle, Armchair } from "lucide-react";
...
export const STATUS_ORDER = ["in-service", "paused", "waiting", "done", "cancelled", "no-show"];
