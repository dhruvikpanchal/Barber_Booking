...
export const barberServices = {
  ...
  uploadGalleryPhoto: (file, alt = "") => {
    const form = new FormData();
    form.append("photo", file);
    if (alt) form.append("alt", alt);
    return post("/barber/profile/gallery/upload", form);
  }, //
  ...
  // Settings
  updatePassword: (data) => patch("/barber/settings/password", data), //

  deleteAccount: () => del("/barber/settings/account"), //
};
