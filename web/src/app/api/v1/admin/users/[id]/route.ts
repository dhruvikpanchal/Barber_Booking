...
const getHandler = (id: string) => adminAuthedRoute((req) => adminController.getUser(req, id));

const patchHandler = (id: string) =>
  adminAuthedRoute((req) => adminController.updateUserStatus(req, id));
...
const deleteHandler = (id: string) =>
  adminAuthedRoute((req) => adminController.deleteUser(req, id));
