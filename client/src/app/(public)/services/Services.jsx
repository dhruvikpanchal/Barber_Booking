      ...
      <section className="pt-32 pb-20 px-4 md:px-16 bg-[#1b1c1c] border-b border-[#53443c]">
        <div className="max-w-[1280px] mx-auto">
          ...
          <p className="text-[#d8c2b7] text-lg leading-relaxed max-w-2xl">
            Every service is performed by a trained specialist using premium
            tools and products. All prices include consultation, styling, and
            finishing.
          </p>
          ...
          {(activeCategory === "all" || activeCategory === "haircut") && (
            <div className="mb-20">
              <div className="flex items-center gap-6 mb-10">
                ...
                <span className="text-[#a08d83] text-xs tracking-[0.1em]">
                  4 SERVICES
                </span>
              </div>
        ...
        <div className="max-w-[1280px] mx-auto flex flex-col md:flex-row justify-between items-center gap-12">
          <div className="max-w-xl">
            ...
            <p className="text-lg leading-relaxed">
              Our barbers are happy to advise during a complimentary
              consultation. Walk in or book a quick call.
            </p>
          </div>
