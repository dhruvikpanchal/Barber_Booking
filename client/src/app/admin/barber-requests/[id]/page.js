...
import BarberRequestDetail from "@/modules/admin/BarberRequestDetail.jsx";
import {
  getBarberRequestById,
  INITIAL_BARBER_REQUESTS,
} from "@/data/admin/barberRequestsData.js";
...
export async function generateMetadata({ params }) {
  ...
  return {
    title: request
      ? `${request.shopName} · Barber request`
      : "Request not found · Admin",
  };
}
