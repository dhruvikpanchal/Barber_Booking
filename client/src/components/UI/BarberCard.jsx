...
function BarberCard({ image, name, role, experience, bio, skills }) {
  return (
    <div className="bg-[#1f2020] border border-[#53443c] hover:border-[#ffb68c] transition-colors overflow-hidden group">
      <div className="grid md:grid-cols-2">
        ...
        <div className="p-8 flex flex-col justify-between">
          <div>
            <span className="text-[#ffb68c] text-xs tracking-[0.2em] block mb-3">{role}</span>

            <h2 className="text-3xl font-bold mb-3">{name}</h2>

            <p className="text-[#a08d83] text-xs tracking-[0.1em] mb-6">{experience}</p>
