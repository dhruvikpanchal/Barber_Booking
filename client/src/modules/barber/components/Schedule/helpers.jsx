  ...
  return (
    <label className="block">
      ...
      <input
        ...
        className="h-10 w-full min-w-[6.5rem] rounded-md border border-outline-variant bg-surface-container px-3 text-sm text-on-surface transition-colors focus:border-primary focus:outline-none disabled:cursor-not-allowed disabled:opacity-40"
      />
    </label>
  );
}
