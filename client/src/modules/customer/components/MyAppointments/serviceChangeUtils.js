...
/**
 * @param {{ bookedAt?: string, acceptedAt?: string|null, arrivedAt?: string|null, inServiceAt?: string|null, completedAt?: string|null, status: string, pendingChangeRequest?: { status: string, requestedAt: string }|null }} appt
 */
