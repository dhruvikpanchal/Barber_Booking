...
export default function FavoriteBarberButton({ isFavorite, onToggle, barberName }) {
  return (
    <button
      type="button"
      onClick={onToggle}
      ...
      className={`inline-flex h-10 items-center gap-2 rounded-xl border px-3.5 text-sm font-semibold transition-all sm:h-11 sm:px-4 ${
        isFavorite
