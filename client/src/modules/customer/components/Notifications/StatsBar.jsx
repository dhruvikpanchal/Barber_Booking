import { TYPE_META, APPOINTMENT_TYPES } from "@/constants/customer/notifications.js";
    ...
    <div className="mb-6 grid grid-cols-2 gap-3 sm:grid-cols-4">
      {STAT_GROUPS.map(({ key, types, metaKey }) => {
        ...
        const count = notifications.filter(
          (n) => types.includes(n.type) && !n.read,
        ).length;
        ...
        return (
          ...
          >
            <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-md bg-surface-container-lowest">
