...
import { INITIAL_NOTIFICATIONS } from "@/data/admin/notifucationsData.js";
import {
  groupByDate,
  TabBar,
  DateGroupLabel,
  EmptyState,
  StatsRow,
} from "./components/Notifications/Primitives.jsx";
    ...
    <div className="mx-auto max-w-7xl space-y-8 pb-4">
      ...
      <div className="border-outline-variant bg-surface-container-low rounded-xl border">
        ...
        <div className="p-4 sm:p-5">
          {filtered.length === 0 ? (
            <EmptyState tab={activeTab} onClearFilter={() => setActiveTab("all")} />
          ) : (
      ...
      {showConfirmClear && (
        ...
        >
          <div
            className="border-outline-variant bg-surface-container-low w-full max-w-sm rounded-xl border p-6 shadow-2xl"
