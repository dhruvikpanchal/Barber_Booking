...
import MessageStats from "./components/ContactMessages/MessageStats.jsx";
import {
  MessageCard,
  MessageTableRow,
} from "./components/ContactMessages/MessageTableRow.jsx";
import { INITIAL_CONTACT_MESSAGES } from "../../data/admin/contactMessagesData.js";
import { Toast } from "@/components/common/settings/TinyPrimitives.jsx";
import { CONTACT_MESSAGE_TABS } from "@/constants/admin/admin.js";
...
export default function ContactMessages() {
  ...
  function toggleRead(id) {
    ...
    showToast(
      wasRead ? "Message marked as read" : "Message marked as unread",
      "success",
    );
  }
    ...
    <div className="mx-auto max-w-7xl space-y-8 pb-4">
      <header className="space-y-2">
        ...
        <p className="max-w-2xl text-sm leading-relaxed text-on-surface-variant">
          Respond to customer questions, platform support requests, booking
          inquiries, and business propositions.
        </p>
      </header>
              ...
              <table className="w-full min-w-[960px] text-left text-sm">
                <thead>
                  <tr className="border-b border-outline-variant text-on-surface-variant">
                    <th className="px-4 py-3 font-label-caps">Sender</th>
                    <th className="px-4 py-3 font-label-caps">
                      Subject / Preview
                    </th>
                    <th className="px-4 py-3 font-label-caps">Date</th>
