...
import { BOOKING_STATUS_CONFIG, USER_STATUS_CONFIG } from "@/constants/admin/admin.js";
import {
  ActivityBadge,
  StatusBadge,
  fmtDate,
  fmtRelative,
  MiniStars,
} from "@/modules/admin/components/Users/helpers.jsx";
...
import {
  ...
  BookingStatusPill,
  PaymentPill,
} from "@/modules/admin/components/UserDetail/Primitives.jsx";
import { UserDetail_ACTIVITY_ICONS } from "@/constants/admin/admin.js";
        ...
        <div className="space-y-5">
          ...
          >
            <div className="grid gap-0 sm:grid-cols-2">
              ...
              <DetailRow label="Join date" value={fmtDate(user.joinedAt)} icon={Calendar} />
                  ...
                  <table className="w-full min-w-[640px] text-left text-sm">
                    ...
                    <tbody>
                      {user.bookingHistory.map((bk) => (
                        ...
                        >
                          <td className="text-on-surface py-3 pr-4">{fmtDate(bk.date)}</td>
                ...
                {user.reviewHistory.map((rev) => (
                  ...
                  >
                    <div className="flex flex-wrap items-center justify-between gap-2">
                      ...
                      <span className="text-on-surface-variant text-xs">{fmtDate(rev.date)}</span>
                    </div>
          ...
          <div className="border-outline-variant bg-surface-container-low rounded-xl border p-5">
            ...
            <dl className="mt-3 space-y-3 text-sm">
              ...
              <div className="border-outline-variant/60 border-t pt-3">
                ...
                <dd className="text-on-surface mt-0.5 font-medium">{fmtDate(user.lastActive)}</dd>
                <dd className="text-on-surface-variant text-xs">{fmtRelative(user.lastActive)}</dd>
              </div>
            </dl>
          </div>
