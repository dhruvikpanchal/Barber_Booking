...
import { NOTIFICATION_TABS, NOTIFICATION_VARIANT_CONFIG } from "@/constants/admin/admin.js";
...
export function EmptyState({ tab, onClearFilter }) {
  return (
    <div className="border-outline-variant flex flex-col items-center justify-center rounded-xl border border-dashed px-6 py-20 text-center">
      <BellOff className="text-on-surface-variant/30 h-10 w-10" aria-hidden />
