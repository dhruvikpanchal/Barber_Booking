...
import { getBarberActionsMenuItems } from "@/constants/admin/admin.js";
    ...
    <div className="relative">
      ...
      {open && (
        <>
          ...
          <div className="absolute right-0 top-full z-20 mt-1 w-48 overflow-hidden rounded-lg border border-outline-variant bg-surface-container shadow-xl">
