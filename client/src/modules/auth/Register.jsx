...
import { register } from "@/config/assets/ImagePath.js";
      ...
      <div className="hidden lg:block lg:w-1/2 relative overflow-hidden">
        ...
        <div className="absolute bottom-12 left-12 right-12">
          ...
          <p className="text-[#d8c2b7] leading-relaxed">
            Create your account to book with our master barbers, track your
            style history, and earn loyalty rewards.
          </p>

          <div className="mt-8 flex gap-8">
            <div>
              <span className="text-[#ffb68c] text-3xl font-bold block">
                Free
              </span>

              <span className="text-[10px] text-[#a08d83] tracking-[0.1em]">
                TO JOIN
              </span>
            </div>
        ...
        <div className="max-w-md w-full mx-auto">
          ...
          <form className="space-y-5">
            ...
            <div className="flex items-start gap-3 pt-2">
              <input
                type="checkbox"
                className="w-4 h-4 mt-1 accent-[#ffb68c]"
              />
